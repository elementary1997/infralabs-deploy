...
echo -e "${BLUE}📥 Импорт курсов, модулей, уроков, упражнений и квестов${NC}"
echo "=========================================="
echo ""
...
if [ -z "$1" ]; then
    ...
    echo ""
    echo "Использование: $0 <json_file> [--update] [--skip-existing] [--restore-ids] [--clear-demo]"
    echo ""
    echo "Параметры:"
    ...
    echo ""
    echo "Импортирует: курсы, модули, уроки, упражнения, ресурсы и квесты (со всеми шагами)"
    echo ""
    echo "Примеры:"
